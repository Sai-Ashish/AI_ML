...
print ('The Lagrangian multiplier be:')
l=float(input())
...
y_pred = np.matmul(train_phi,w_opt)+ np.mean(train_y)

#trining error
print ('training error:')
print error(train_y,np.matmul(train_phi,w_opt))+l*(np.matmul(w_opt.T,w_opt))
